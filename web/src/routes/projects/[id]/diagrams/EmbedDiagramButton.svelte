...
{#if isModalOpen}
  <div class="modal modal-open">
    <div class="modal-box max-w-lg bg-base-100 border border-base-300 shadow-2xl">
      <div class="flex items-center justify-between pb-2 border-b border-base-300 mb-4">
      ...
      <div class="flex flex-col gap-4 text-sm">
        ...
        <div class="flex flex-col gap-1.5">
          <span class="font-semibold text-xs uppercase tracking-wide text-base-content/70">
            Direct Embed URL
          </span>
        ...
        <!-- Preview Action -->
        <div class="pt-2 flex items-center justify-between border-t border-base-300">
