    ...
    >
      ...
      <main class="md:col-span-6 lg:col-span-8 flex">
        ...
        >
          ...
          <textarea
            class="flex-1 w-full p-4 border rounded resize-none bg-gray-700 text-gray-100 border-gray-600 placeholder-gray-400"
      ...
      >
        ...
        <div class="text-sm text-gray-300 space-y-2">
          <div class="p-2 bg-gray-800 rounded">
            Status: <span class="font-medium text-white">OK</span>
          </div>
