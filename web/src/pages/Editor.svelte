<script lang="ts">
  import { get_editor_state, switch_state_zooming } from '../ViewEditorState.svelte'

  let editor_state = get_editor_state();
...
<div class="h-screen w-screen flex flex-col">
  <div class="navbar bg-base-200">
    ...
    <span class="ml-2 text-sm opacity-60">Three.js Playground. State: state_here</span>
  </div>
