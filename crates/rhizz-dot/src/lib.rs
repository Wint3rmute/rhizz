//! `rhizz-dot` — Graphviz DOT rendering for rhizz models.
//!
//! The public entry point is [`render_view`], which converts a resolved
//! [`rhizz_core::View`] (with its filter predicates) into a Graphviz DOT
//! string ready to be written to a `.dot` file.
//!
